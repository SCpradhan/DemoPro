...
WebDriver driver;
                                                 ...
                                                 //Copy from Guru99.com-softwaretesting-mobile testing.
@BeforeClass
public void setUp() throws MalformedURLException{
	//Set up desired capabilities and pass the Android app-activity and app-package to Appium
	DesiredCapabilities capabilities = new DesiredCapabilities();//Automatic ServerCustom Server
...
public void testCal() throws Exception {
   ...
   four.click();
   WebElement equalTo=driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"equals\"]"));
   equalTo.click();
